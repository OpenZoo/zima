...
class ElementLibrarySuperZZT {
    ...
    private static final Element TEXT_BLUE = Element.builder().id(73).build();
    private static final Element TEXT_GREEN = Element.builder().id(74).build();
    private static final Element TEXT_CYAN = Element.builder().id(75).build();
    private static final Element TEXT_RED = Element.builder().id(76).build();
    private static final Element TEXT_PURPLE = Element.builder().id(77).build();
    private static final Element TEXT_YELLOW = Element.builder().id(78).build();
    private static final Element TEXT_WHITE = Element.builder().id(79).build();
