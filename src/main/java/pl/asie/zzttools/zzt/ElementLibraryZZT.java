...
public class ElementLibraryZZT {
    ...
    private static final Element TEXT_BLUE = Element.builder().id(47).build();
    private static final Element TEXT_GREEN = Element.builder().id(48).build();
    private static final Element TEXT_CYAN = Element.builder().id(49).build();
    private static final Element TEXT_RED = Element.builder().id(50).build();
    private static final Element TEXT_PURPLE = Element.builder().id(51).build();
    private static final Element TEXT_YELLOW = Element.builder().id(52).build();
    private static final Element TEXT_WHITE = Element.builder().id(53).build();
